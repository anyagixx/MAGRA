...
Updated current release target to v0.1.3 for release-surface hardening.
=== END_CHANGE_SUMMARY === -->
...
Package preview: `magra-0.1.3.tgz`
...
rtk git tag -a v0.1.3 -m "MAGRA v0.1.3"
...
```bash
rtk git push origin :refs/tags/v0.1.3
rtk git tag -d v0.1.3
```
