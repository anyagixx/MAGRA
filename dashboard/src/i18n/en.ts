export const en = {
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside magra code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside magra code to attach.",
  ...
  usage: {
    ...
    noData: "No usage data yet — run a turn in magra chat / code / run and refresh.",
  ...
  sessions: {
    ...
    attachRequired:
      "Live session operations need an attached CLI session. Launch via magra chat or open the dashboard from inside a TUI session.",
    activeChip: "active",
    activePill: "active",
  },
  tools: {
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active magra code session — standalone magra dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart magra code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when magra code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart magra code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "MAGRA tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart magra code to retry.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `magra code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.reasonix/config.json. Restart `magra code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from magra code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with MAGRA; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run magra index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "MAGRA doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. MAGRA will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",
  ...
  statusbar: {
    ...
    exchangeRatePending: "exchange rate loading",
    exchangeRateUpdated: "updated {time}",
    jobs: "Jobs",
    jobsTip: "Background jobs",
    offline: "Offline",
    online: "Online",
    rtk: "RTK",
    rtkPending: "RTK savings pending",
    rtkSessionSaved: "RTK saved {tokens} tokens this session",
    rtkTotalSaved: "total {tokens} saved",
    rtkUnavailable: "RTK savings unavailable",
    switchCurrency: "Switch currency",
    switchCurrencyTo: "Switch to {currency}",
