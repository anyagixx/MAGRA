...
LangString appRunning ${LANG_ENGLISH} "MAGRA is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "MAGRA is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill MAGRA. Please close it first then try again"
