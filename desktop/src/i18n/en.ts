export const en = {
  ...
  settings: {
    ...
    mcpBridged: "· Bridged",
    mcpNotBridged:
      "· Current desktop session not bridged — restart magra code (TUI) to take effect",
  ...
  app: {
    ...
    connecting: "Connecting to MAGRA core…",
    startupFailedTitle: "MAGRA could not start",
  ...
  notifications: {
    approvalTitle: "MAGRA is waiting for approval",
    inputTitle: "MAGRA is waiting for input",
    planApprovalTitle: "MAGRA is waiting for plan approval",
    checkpointApprovalTitle: "MAGRA is waiting for checkpoint approval",
    revisionTitle: "MAGRA proposed a plan revision",
    commandBody: "Command: {command}",
    readBody: "Read: {path}",
    writeBody: "Write: {path}",
    turnCompleteTitle: "MAGRA task complete",
