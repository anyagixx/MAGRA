...
export const de: typeof en = {
  ...
  toast: {
    ...
    cleared: "UI geleert",
    aboutLine: "MAGRA v{version} · Cache-First-DeepSeek-Agent",
  },
  composer: {
    ...en.composer,
    busy: "MAGRA denkt nach...",
    idle: "Frag etwas",
    send: "senden",
    newline: "neue Zeile",
    commands: "Befehle",
  ...
  settings: {
    ...
    mcpNotBridged:
      "· Aktuelle Desktop-Sitzung nicht verbunden — starte magra code (TUI) neu, um wirksam zu werden",
  ...
  app: {
    ...
    connecting: "Verbinde mit MAGRA core...",
    startupFailedTitle: "MAGRA konnte nicht starten",
  ...
  notifications: {
    ...en.notifications,
    approvalTitle: "MAGRA wartet auf Genehmigung",
    inputTitle: "MAGRA wartet auf Eingabe",
    planApprovalTitle: "MAGRA wartet auf Plan-Genehmigung",
    checkpointApprovalTitle: "MAGRA wartet auf Checkpoint-Genehmigung",
    revisionTitle: "MAGRA hat eine Plan-Überarbeitung vorgeschlagen",
    commandBody: "Befehl: {command}",
    readBody: "Lesen: {path}",
    writeBody: "Schreiben: {path}",
    turnCompleteTitle: "MAGRA-Aufgabe abgeschlossen",
