export const ja = {
  ...
  toast: {
    ...
    cleared: "UIをクリアしました",
    aboutLine: "MAGRA v{version} · キャッシュファーストDeepSeekエージェント",
  },
  composer: {
    busy: "MAGRAが考え中…",
    idle: "質問する",
  ...
  settings: {
    ...
    mcpBridged: "· ブリッジ済み",
    mcpNotBridged:
      "· 現在のデスクトップセッションはブリッジされていません — magra code (TUI) を再起動すると有効になります",
  ...
  app: {
    ...
    connecting: "MAGRAコアに接続中…",
    startupFailedTitle: "MAGRAを起動できませんでした",
  ...
  notifications: {
    approvalTitle: "MAGRAが承認待ちです",
    inputTitle: "MAGRAが入力を待っています",
    planApprovalTitle: "MAGRAがプラン承認待ちです",
    checkpointApprovalTitle: "MAGRAがチェックポイント承認待ちです",
    revisionTitle: "MAGRAがプラン修正を提案しました",
    commandBody: "コマンド: {command}",
    readBody: "読み取り: {path}",
    writeBody: "書き込み: {path}",
    turnCompleteTitle: "MAGRAタスク完了",
