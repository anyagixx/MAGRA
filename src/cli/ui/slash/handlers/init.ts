...
const INIT_PROMPT = [
  "# Task: Initialize MAGRA.md",
  "",
  "I want you to generate a MAGRA.md at the project root that captures",
  "the working knowledge a future MAGRA session needs to be productive",
  ...
  "5. Write MAGRA.md with the sections below, skipping any you can't",
  "   fill from evidence.",
  "",
  ...
  "## Output",
  "",
  "Write the result to `MAGRA.md` in the project root using the",
...
const init: SlashHandler = (args, _loop, ctx) => {
  ...
  const target = pathMod.join(ctx.codeRoot, "MAGRA.md");
